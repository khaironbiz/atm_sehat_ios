//
//  WheelMonitorScanViewController.m
...
@interface WheelMonitorScanViewController ()<UITableViewDelegate,UITableViewDataSource,WheelMonitorBleManagerDelegate>
...
@implementation WheelMonitorScanViewController
...
-(void)viewDidDisappear:(BOOL)animated{
    ...
    [[ELWheelMonitorBleManager shareManager] stopScan];
}
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ELPeripheralModel *p = self.devices[indexPath.row];
    WheelMonitorConnectViewController *vc = [[WheelMonitorConnectViewController alloc] init];
    vc.p = p;
